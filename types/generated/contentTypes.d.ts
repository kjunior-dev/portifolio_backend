...
export interface ApiCategoriasDeProjetoCategoriasDeProjeto
  extends Struct.CollectionTypeSchema {
  collectionName: 'categorias_de_projetos';
  info: {
    displayName: 'Categorias de Projeto';
    pluralName: 'categorias-de-projetos';
    singularName: 'categorias-de-projeto';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categorias-de-projeto.categorias-de-projeto'
    > &
      Schema.Attribute.Private;
...
export interface ApiConfiguracoesDoSiteConfiguracoesDoSite
  extends Struct.SingleTypeSchema {
  collectionName: 'configuracoes_do_sites';
  info: {
    displayName: 'Configura\u00E7\u00F5es do Site';
    pluralName: 'configuracoes-do-sites';
    singularName: 'configuracoes-do-site';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::configuracoes-do-site.configuracoes-do-site'
    > &
      Schema.Attribute.Private;
...
export interface ApiPaginaInicialPaginaInicial extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experienciaProfissional: Schema.Attribute.Component<
    ...
    formacaoCertificacoes: Schema.Attribute.Component<
      ...
      false
    >;
    hero: Schema.Attribute.Component<'sections.hero-principal', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    projetos: Schema.Attribute.Component<'sections.projetos', false>;
    publishedAt: Schema.Attribute.DateTime;
    servicos: Schema.Attribute.Component<'sections.seccao-de-cards', false>;
    sobreMim: Schema.Attribute.Component<'sections.sobre-mim', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProjetoProjeto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoriaPrincipal: Schema.Attribute.Relation<
      ...
      'api::categorias-de-projeto.categorias-de-projeto'
    >;
    categorias_de_projetos: Schema.Attribute.Relation<
      'manyToMany',
      'api::categorias-de-projeto.categorias-de-projeto'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    funcionalidades: Schema.Attribute.Component<
      'shared.funcionalidade-do-projeto',
      true
    >;
    ...
    > &
      Schema.Attribute.Private;
    minhaParticipacao: Schema.Attribute.Text & Schema.Attribute.Required;
    ordem: Schema.Attribute.Integer;
    problemaResolvido: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    urlCodigo: Schema.Attribute.String;
    urlDemo: Schema.Attribute.String;
  };
}
